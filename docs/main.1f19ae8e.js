...
},{}],"../src/Calendar.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    ...
    localeMonth: function localeMonth() {
      if (this.locale === 'cn') {
    ...
    monthPaneVisible: function monthPaneVisible() {
      return this.paneStatus === 1;
    },
    yearPaneVisible: function yearPaneVisible() {
  ...
  methods: {
    ...
    toSpecificDate: function toSpecificDate(year, month, date) {
      ...
      if (isNaNs(intYear, intMonth, intDate).some(function (item) {
        return item === true;
      })) return;
    ...
    _handleDateItemSelect: function _handleDateItemSelect(item) {
      if (item.monthFlag === 0) {
        this.toPreMonth();
    ...
    _getDateArr: function _getDateArr() {
      ...
      var beginDate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      var endDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 31;
      var monthFlag = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
      ...
      return new Array(endDate - beginDate + 1).fill().map(function (_, index) {
        return {
          val: "".concat(tarYear, "-").concat(tarMonth, "-").concat(index + beginDate),
          date: index + beginDate,
          monthFlag: monthFlag,
          dotted: monthFlag === 1 && _this.dotArr[index],
          isToday: _this._getDateStr(_this.today) === "".concat(tarYear, "-").concat(tarMonth, "-").concat(index + beginDate)
        };
      });
    },
    _updateMonthArr: function _updateMonthArr() {
      ...
      var preDateArr = this._getDateArr(maxDateOfPreMonth - firstDayOfCurMonth + 1, maxDateOfPreMonth, 0);

      var curDateArr = this._getDateArr(1, getMonthMaxDate(this.curYear, this.curMonth), 1);

      var nextDateArr = this._getDateArr(1, getMonthMaxDate(this.curYear, this.curMonth + 1), 2); // 6 line max: 6 * 7 = 42


      this.dateArr = preDateArr.concat(curDateArr).concat(nextDateArr).slice(0, 42);
    },
...
exports.default = _default;
        var $4d2c90 = exports.default || module.exports;
      
      if (typeof $4d2c90 === 'function') {
        $4d2c90 = $4d2c90.options;
      }
    
        /* template */
        Object.assign($4d2c90, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "calendar" }, [
    _c("div", { staticClass: "banner" }, [
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.datePaneVisible,
              expression: "datePaneVisible"
            }
          ],
          staticClass: "arrow arrow--inner",
      ...
      _c(
        ...
        [_vm._v(_vm._s(_vm.localeYearRange))]
      ),
      _vm._v(" "),
      _c(
        "span",
        {
          ...
          on: { click: _vm.showYearPane }
        },
        [_vm._v(_vm._s(_vm.localeYear))]
      ),
      _vm._v(" "),
      _c(
        "span",
        {
          ...
          on: { click: _vm.showMonthPane }
        },
        [_vm._v(_vm._s(_vm.localeMonth))]
      ),
      _vm._v(" "),
      _c("div", { staticClass: "arrow-wrap arrow-wrap--right" }, [
        _c("div", {
          directives: [
            {
              name: "show",
    ...
    _c(
      ...
      [
        ...
        _c(
          "div",
          _vm._l(_vm.dateArr, function(item, j) {
            return _c(
              "div",
              {
                key: "date" + j,
                ...
                on: {
                  click: function($event) {
                    return _vm._handleDateItemSelect(item)
                  }
                }
              },
              [
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.monthPaneVisible,
            expression: "monthPaneVisible"
          }
        ],
        staticClass: "pane pane--month"
      },
      _vm._l(_vm.monthArr, function(month, k) {
        return _c(
          "div",
          {
            key: "month" + k,
            class: {
              "month-item": true,
              "month-item--selected":
                k === _vm.value.getMonth() &&
                _vm.curMonth === _vm.value.getMonth() + 1 &&
                _vm.curYear === _vm.value.getFullYear()
                  ? "bolder"
                  : ""
            },
            on: {
              click: function($event) {
                return _vm._handleMonthItemSelect(k)
              }
            }
          },
          [_vm._v("\n      " + _vm._s(month) + "\n    ")]
    ...
    _c(
      "div",
      {
        ...
        staticClass: "pane pane--year"
      },
      _vm._l(_vm.yearArr, function(year, l) {
        return _c(
          "div",
          {
            key: "year" + l,
            ...
            on: {
              click: function($event) {
                return _vm._handleYearItemSelect(year)
              }
            }
          },
          [_vm._v("\n      " + _vm._s(year) + "\n    ")]
    ...
    _vm._v(" "),
    _c("div", { staticClass: "comment" }, [_vm._t("comment")], 2)
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4d2c90', $4d2c90);
          } else {
            api.reload('$4d2c90', $4d2c90);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    toSpecificDate: function toSpecificDate() {
      this.$refs['calendar'].toSpecificDate(2019, 7, 1);
    }
  }
};
exports.default = _default;
        var $a11f60 = exports.default || module.exports;
      
      if (typeof $a11f60 === 'function') {
        $a11f60 = $a11f60.options;
      }
    
        /* template */
        Object.assign($a11f60, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "operation" }, [
        _c("div", { staticClass: "row" }, [
          ...
          _c("label", { attrs: { for: "locale" } }, [
            _c("input", {
              ...
              attrs: { type: "radio", name: "cn", value: "cn" },
              domProps: { checked: _vm._q(_vm.locale, "cn") },
              on: {
          ...
          _c("label", { attrs: { for: "locale" } }, [
            _c("input", {
              ...
              attrs: { type: "radio", name: "en", value: "en" },
              domProps: { checked: _vm._q(_vm.locale, "en") },
              on: {
                change: function($event) {
                  _vm.locale = "en"
                }
        ...
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
          _c("button", { on: { click: _vm.backToToday } }, [
            _vm._v("Back to today")
          ]),
          _vm._v(" "),
          _c("button", { on: { click: _vm.toPreMonth } }, [
            _vm._v("To previous month")
          ]),
          _vm._v(" "),
          _c("button", { on: { click: _vm.toNextMonth } }, [
            _vm._v("To next month")
          ]),
          _vm._v(" "),
          _c("button", { on: { click: _vm.toPreYear } }, [
            _vm._v("To previous year")
          ]),
          _vm._v(" "),
          _c("button", { on: { click: _vm.toNextYear } }, [
            _vm._v("To next year")
          ]),
          _vm._v(" "),
          _c("button", { on: { click: _vm.toSpecificDate } }, [
            _vm._v("To 2019/07/01")
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a11f60', $a11f60);
          } else {
            api.reload('$a11f60', $a11f60);
          }
        }
...
},{"../src/Calendar":"../src/Calendar.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
