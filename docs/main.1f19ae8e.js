...
},{}],"Calendar.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    _getDateArr: function _getDateArr() {
      ...
      return new Array(endDate - beginDate + 1).fill().map(function (_, index) {
        return {
          ...
          monthFlag: monthFlag,
          marked: monthFlag === 1 && _this.markArr[index],
    ...
    _updateMonthArr: function _updateMonthArr() {
      ...
      var preMonthArr = this._getDateArr(maxDateOfPreMonth - firstDayOfCurMonth + 1, maxDateOfPreMonth, 0);

      var curMonthArr = this._getDateArr(1, getMonthMaxDate(this.curYear, this.curMonth), 1);

      var nextMonthArr = this._getDateArr(1, getMonthMaxDate(this.curYear, this.curMonth + 1), 2); // 6 line max: 6 * 7 = 42


      this.monthArr = preMonthArr.concat(curMonthArr).concat(nextMonthArr).slice(0, 42);
    },
...
exports.default = _default;
        var $a64ff7 = exports.default || module.exports;
      
      if (typeof $a64ff7 === 'function') {
        $a64ff7 = $a64ff7.options;
      }
    
        /* template */
        Object.assign($a64ff7, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a64ff7', $a64ff7);
          } else {
            api.reload('$a64ff7', $a64ff7);
          }
        }
...
},{"./Calendar":"Calendar.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
